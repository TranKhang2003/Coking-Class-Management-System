...
namespace CookingClassManagementSystem.DTO
{
    public class ChiTietLopHocDTO
    {
        ...
        public ChiTietLopHocDTO(int maLopHocChiTiet, int maLopHoc, decimal phiDiaDiem, decimal tongThu, decimal giamGia, decimal tienHoanLai, decimal nguyenLieu, decimal phiKhac, decimal thucThu, string trangThai)
        {
        ...
        public ChiTietLopHocDTO(DataRow row)
        {
